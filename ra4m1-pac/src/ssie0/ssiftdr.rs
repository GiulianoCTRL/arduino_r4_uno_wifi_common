...
pub type SSIFTDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl W {
    #[doc = "Bits 0:31 - Transmit FIFO Data"]
    #[inline(always)]
    #[must_use]
    pub fn ssiftdr(&mut self) -> SSIFTDR_W<SSIFTDR_SPEC, 0> {
        SSIFTDR_W::new(self)
    }
...
#[doc = "Transmit FIFO Data Register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ssiftdr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
