...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enb(&mut self) -> ENB_W<BCNT0AER_SPEC, 0> {
        ENB_W::new(self)
    }
...
#[doc = "Binary Counter 0 Alarm Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bcnt0aer::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bcnt0aer::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
