...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mon1(&mut self) -> MON1_W<RMONAR_SPEC, 0> {
        MON1_W::new(self)
    }
    #[doc = "Bit 4 - 10 Months Value for the tens place of months"]
    #[inline(always)]
    #[must_use]
    pub fn mon10(&mut self) -> MON10_W<RMONAR_SPEC, 4> {
        MON10_W::new(self)
    }
    #[doc = "Bit 7 - Compare enable"]
    #[inline(always)]
    #[must_use]
    pub fn enb(&mut self) -> ENB_W<RMONAR_SPEC, 7> {
        ENB_W::new(self)
    }
...
#[doc = "Month Alarm Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rmonar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rmonar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
