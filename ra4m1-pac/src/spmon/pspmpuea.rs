...
pub type PSPMPUEA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pspmpuea(&mut self) -> PSPMPUEA_W<PSPMPUEA_SPEC, 0> {
        PSPMPUEA_W::new(self)
    }
...
#[doc = "Process Stack Pointer (PSP) Monitor End Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pspmpuea::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pspmpuea::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
