...
pub type R = crate::R<PSPMPUPT_SPEC>;
#[doc = "Register `PSPMPUPT` writer"]
pub type W = crate::W<PSPMPUPT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn protect(&mut self) -> PROTECT_W<PSPMPUPT_SPEC, 0> {
        PROTECT_W::new(self)
    }
    #[doc = "Bits 8:15 - Key Code The data written to these bits are not stored."]
    #[inline(always)]
    #[must_use]
    pub fn key(&mut self) -> KEY_W<PSPMPUPT_SPEC, 8> {
        KEY_W::new(self)
    }
...
#[doc = "Stack Pointer Monitor Protection Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pspmpupt::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pspmpupt::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
