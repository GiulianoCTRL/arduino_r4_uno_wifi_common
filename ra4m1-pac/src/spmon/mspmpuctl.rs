...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> ENABLE_W<MSPMPUCTL_SPEC, 0> {
        ENABLE_W::new(self)
    }
    #[doc = "Bit 8 - Stack Pointer Monitor Error Flag"]
    #[inline(always)]
    #[must_use]
    pub fn error(&mut self) -> ERROR_W<MSPMPUCTL_SPEC, 8> {
        ERROR_W::new(self)
    }
...
#[doc = "Stack Pointer Monitor Access Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mspmpuctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mspmpuctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
