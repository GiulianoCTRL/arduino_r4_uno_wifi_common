...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arbmet(&mut self) -> ARBMET_W<BUSSCNTP6B_SPEC, 4> {
        ARBMET_W::new(self)
    }
...
#[doc = "Slave Bus Control Register P6B\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`busscntp6b::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`busscntp6b::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
