...
pub type R = crate::R<BUSSCNTFBU_SPEC>;
#[doc = "Register `BUSSCNTFBU` writer"]
pub type W = crate::W<BUSSCNTFBU_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arbmet(&mut self) -> ARBMET_W<BUSSCNTFBU_SPEC, 4> {
        ARBMET_W::new(self)
    }
...
#[doc = "Slave Bus Control Register FBU\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`busscntfbu::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`busscntfbu::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
