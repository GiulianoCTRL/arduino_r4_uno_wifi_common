...
pub type R = crate::R<WDTSR_SPEC>;
#[doc = "Register `WDTSR` writer"]
pub type W = crate::W<WDTSR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn undff(&mut self) -> UNDFF_W<WDTSR_SPEC, 14> {
        UNDFF_W::new(self)
    }
    #[doc = "Bit 15 - Refresh Error Flag"]
    #[inline(always)]
    #[must_use]
    pub fn refef(&mut self) -> REFEF_W<WDTSR_SPEC, 15> {
        REFEF_W::new(self)
    }
...
#[doc = "WDT Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wdtsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wdtsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
