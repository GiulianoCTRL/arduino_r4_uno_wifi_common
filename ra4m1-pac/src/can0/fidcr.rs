...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eid(&mut self) -> EID_W<FIDCR_SPEC, 0> {
        EID_W::new(self)
    }
    #[doc = "Bits 18:28 - Standard ID"]
    #[inline(always)]
    #[must_use]
    pub fn sid(&mut self) -> SID_W<FIDCR_SPEC, 18> {
        SID_W::new(self)
    }
    #[doc = "Bit 30 - Remote Transmission Request"]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RTR_W<FIDCR_SPEC, 30> {
        RTR_W::new(self)
    }
    #[doc = "Bit 31 - ID Extension"]
    #[inline(always)]
    #[must_use]
    pub fn ide(&mut self) -> IDE_W<FIDCR_SPEC, 31> {
        IDE_W::new(self)
    }
