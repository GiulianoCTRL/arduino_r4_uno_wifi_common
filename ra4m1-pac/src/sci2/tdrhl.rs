...
pub type TDRHL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl W {
    #[doc = "Bits 0:15 - TDRHL is a 16-bit register that stores transmit data."]
    #[inline(always)]
    #[must_use]
    pub fn tdrhl(&mut self) -> TDRHL_W<TDRHL_SPEC, 0> {
        TDRHL_W::new(self)
    }
...
#[doc = "Transmit 9-bit Data Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tdrhl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tdrhl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
