...
pub type R = crate::R<P000PFS_HA_SPEC>;
#[doc = "Register `P000PFS_HA` writer"]
pub type W = crate::W<P000PFS_HA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn podr(&mut self) -> PODR_W<P000PFS_HA_SPEC, 0> {
        PODR_W::new(self)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    #[must_use]
    pub fn pdr(&mut self) -> PDR_W<P000PFS_HA_SPEC, 2> {
        PDR_W::new(self)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    #[must_use]
    pub fn pcr(&mut self) -> PCR_W<P000PFS_HA_SPEC, 4> {
        PCR_W::new(self)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    #[must_use]
    pub fn ncodr(&mut self) -> NCODR_W<P000PFS_HA_SPEC, 6> {
        NCODR_W::new(self)
    }
    #[doc = "Bit 10 - Port Drive Capability"]
    #[inline(always)]
    #[must_use]
    pub fn dscr(&mut self) -> DSCR_W<P000PFS_HA_SPEC, 10> {
        DSCR_W::new(self)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    #[must_use]
    pub fn isel(&mut self) -> ISEL_W<P000PFS_HA_SPEC, 14> {
        ISEL_W::new(self)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn asel(&mut self) -> ASEL_W<P000PFS_HA_SPEC, 15> {
        ASEL_W::new(self)
    }
