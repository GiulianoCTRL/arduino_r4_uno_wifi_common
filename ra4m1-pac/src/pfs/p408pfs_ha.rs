#[doc = "Register `P408PFS_HA` reader"]
pub type R = crate::R<P408PFS_HA_SPEC>;
#[doc = "Register `P408PFS_HA` writer"]
pub type W = crate::W<P408PFS_HA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn podr(&mut self) -> PODR_W<P408PFS_HA_SPEC, 0> {
        PODR_W::new(self)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    #[must_use]
    pub fn pdr(&mut self) -> PDR_W<P408PFS_HA_SPEC, 2> {
        PDR_W::new(self)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    #[must_use]
    pub fn pcr(&mut self) -> PCR_W<P408PFS_HA_SPEC, 4> {
        PCR_W::new(self)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    #[must_use]
    pub fn ncodr(&mut self) -> NCODR_W<P408PFS_HA_SPEC, 6> {
        NCODR_W::new(self)
    }
    #[doc = "Bit 10 - Drive Strength Control Register"]
    #[inline(always)]
    #[must_use]
    pub fn dscr(&mut self) -> DSCR_W<P408PFS_HA_SPEC, 10> {
        DSCR_W::new(self)
    }
    #[doc = "Bit 11 - Drive Strength Control Register"]
    #[inline(always)]
    #[must_use]
    pub fn dscr1(&mut self) -> DSCR1_W<P408PFS_HA_SPEC, 11> {
        DSCR1_W::new(self)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    #[must_use]
    pub fn eor(&mut self) -> EOR_W<P408PFS_HA_SPEC, 12> {
        EOR_W::new(self)
    }
    #[doc = "Bit 13 - Event on Falling"]
    #[inline(always)]
    #[must_use]
    pub fn eof(&mut self) -> EOF_W<P408PFS_HA_SPEC, 13> {
        EOF_W::new(self)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    #[must_use]
    pub fn isel(&mut self) -> ISEL_W<P408PFS_HA_SPEC, 14> {
        ISEL_W::new(self)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn asel(&mut self) -> ASEL_W<P408PFS_HA_SPEC, 15> {
        ASEL_W::new(self)
    }
...
#[doc = "P408 Pin Function Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`p408pfs_ha::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`p408pfs_ha::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P408PFS_HA_SPEC;
impl crate::RegisterSpec for P408PFS_HA_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`p408pfs_ha::R`](R) reader structure"]
impl crate::Readable for P408PFS_HA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`p408pfs_ha::W`](W) writer structure"]
impl crate::Writable for P408PFS_HA_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P408PFS_HA to value 0"]
impl crate::Resettable for P408PFS_HA_SPEC {
