#[doc = "Register `P109PFS` reader"]
pub type R = crate::R<P109PFS_SPEC>;
#[doc = "Register `P109PFS` writer"]
pub type W = crate::W<P109PFS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn podr(&mut self) -> PODR_W<P109PFS_SPEC, 0> {
        PODR_W::new(self)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    #[must_use]
    pub fn pdr(&mut self) -> PDR_W<P109PFS_SPEC, 2> {
        PDR_W::new(self)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    #[must_use]
    pub fn pcr(&mut self) -> PCR_W<P109PFS_SPEC, 4> {
        PCR_W::new(self)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    #[must_use]
    pub fn ncodr(&mut self) -> NCODR_W<P109PFS_SPEC, 6> {
        NCODR_W::new(self)
    }
    #[doc = "Bit 10 - Port Drive Capability"]
    #[inline(always)]
    #[must_use]
    pub fn dscr(&mut self) -> DSCR_W<P109PFS_SPEC, 10> {
        DSCR_W::new(self)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    #[must_use]
    pub fn eor(&mut self) -> EOR_W<P109PFS_SPEC, 12> {
        EOR_W::new(self)
    }
    #[doc = "Bit 13 - Event on Failing"]
    #[inline(always)]
    #[must_use]
    pub fn eof(&mut self) -> EOF_W<P109PFS_SPEC, 13> {
        EOF_W::new(self)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    #[must_use]
    pub fn isel(&mut self) -> ISEL_W<P109PFS_SPEC, 14> {
        ISEL_W::new(self)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn asel(&mut self) -> ASEL_W<P109PFS_SPEC, 15> {
        ASEL_W::new(self)
    }
    #[doc = "Bit 16 - Port Mode Control"]
    #[inline(always)]
    #[must_use]
    pub fn pmr(&mut self) -> PMR_W<P109PFS_SPEC, 16> {
        PMR_W::new(self)
    }
    #[doc = "Bits 24:28 - Port Function Select These bits select the peripheral function. For individual pin functions, see the setting table."]
    #[inline(always)]
    #[must_use]
    pub fn psel(&mut self) -> PSEL_W<P109PFS_SPEC, 24> {
        PSEL_W::new(self)
    }
...
#[doc = "P109 Pin Function Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`p109pfs::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`p109pfs::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P109PFS_SPEC;
impl crate::RegisterSpec for P109PFS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p109pfs::R`](R) reader structure"]
impl crate::Readable for P109PFS_SPEC {}
#[doc = "`write(|w| ..)` method takes [`p109pfs::W`](W) writer structure"]
impl crate::Writable for P109PFS_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P109PFS to value 0x0001_0000"]
impl crate::Resettable for P109PFS_SPEC {
