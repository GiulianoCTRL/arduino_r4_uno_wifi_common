...
pub type R = crate::R<SMPUSRAM0_SPEC>;
#[doc = "Register `SMPUSRAM0` writer"]
pub type W = crate::W<SMPUSRAM0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rpcpu(&mut self) -> RPCPU_W<SMPUSRAM0_SPEC, 0> {
        RPCPU_W::new(self)
    }
    #[doc = "Bit 1 - CPU Write protection"]
    #[inline(always)]
    #[must_use]
    pub fn wpcpu(&mut self) -> WPCPU_W<SMPUSRAM0_SPEC, 1> {
        WPCPU_W::new(self)
    }
    #[doc = "Bit 2 - Master Group A Read protection"]
    #[inline(always)]
    #[must_use]
    pub fn rpgrpa(&mut self) -> RPGRPA_W<SMPUSRAM0_SPEC, 2> {
        RPGRPA_W::new(self)
    }
    #[doc = "Bit 3 - Master Group A Write protection"]
    #[inline(always)]
    #[must_use]
    pub fn wpgrpa(&mut self) -> WPGRPA_W<SMPUSRAM0_SPEC, 3> {
        WPGRPA_W::new(self)
    }
