...
pub type R = crate::R<MMPUPTA_SPEC>;
#[doc = "Register `MMPUPTA` writer"]
pub type W = crate::W<MMPUPTA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn protect(&mut self) -> PROTECT_W<MMPUPTA_SPEC, 0> {
        PROTECT_W::new(self)
    }
    #[doc = "Bits 8:15 - Write Keyword The data written to these bits are not stored."]
    #[inline(always)]
    #[must_use]
    pub fn key(&mut self) -> KEY_W<MMPUPTA_SPEC, 8> {
        KEY_W::new(self)
    }
...
#[doc = "Group A Protection of Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mmpupta::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mmpupta::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
