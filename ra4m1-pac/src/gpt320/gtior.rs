...
pub type GTIOA_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 5, O, GTIOA_A>;
impl<'a, REG, const O: u8> GTIOA_W<'a, REG, O>
where
...
pub type OADFLT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OADFLT_A>;
impl<'a, REG, const O: u8> OADFLT_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The GTIOCA pin outputs low when counting is stopped."]
...
pub type OAHLD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OAHLD_A>;
impl<'a, REG, const O: u8> OAHLD_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The GTIOCA pin output level at start/stop of counting depends on the register setting."]
...
pub type OAE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OAE_A>;
impl<'a, REG, const O: u8> OAE_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Output is disabled"]
...
pub type OADF_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, OADF_A>;
impl<'a, REG, const O: u8> OADF_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type NFAEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, NFAEN_A>;
impl<'a, REG, const O: u8> NFAEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The noise filter for the GTIOCA pin is disabled."]
...
pub type NFCSA_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, NFCSA_A>;
impl<'a, REG, const O: u8> NFCSA_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type GTIOB_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 5, O, GTIOB_A>;
impl<'a, REG, const O: u8> GTIOB_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type OBDFLT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OBDFLT_A>;
impl<'a, REG, const O: u8> OBDFLT_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The GTIOCB pin outputs low when counting is stopped."]
...
pub type OBHLD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OBHLD_A>;
impl<'a, REG, const O: u8> OBHLD_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The GTIOCB pin output level at start/stop of counting depends on the register setting."]
...
pub type OBE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OBE_A>;
impl<'a, REG, const O: u8> OBE_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Output is disabled"]
...
pub type OBDF_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, OBDF_A>;
impl<'a, REG, const O: u8> OBDF_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type NFBEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, NFBEN_A>;
impl<'a, REG, const O: u8> NFBEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "The noise filter for the GTIOCB pin is disabled."]
...
pub type NFCSB_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, NFCSB_A>;
impl<'a, REG, const O: u8> NFCSB_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gtioa(&mut self) -> GTIOA_W<GTIOR_SPEC, 0> {
        GTIOA_W::new(self)
    }
    #[doc = "Bit 6 - GTIOCA Pin Output Value Setting at the Count Stop"]
    #[inline(always)]
    #[must_use]
    pub fn oadflt(&mut self) -> OADFLT_W<GTIOR_SPEC, 6> {
        OADFLT_W::new(self)
    }
    #[doc = "Bit 7 - GTIOCA Pin Output Setting at the Start/Stop Count"]
    #[inline(always)]
    #[must_use]
    pub fn oahld(&mut self) -> OAHLD_W<GTIOR_SPEC, 7> {
        OAHLD_W::new(self)
    }
    #[doc = "Bit 8 - GTIOCA Pin Output Enable"]
    #[inline(always)]
    #[must_use]
    pub fn oae(&mut self) -> OAE_W<GTIOR_SPEC, 8> {
        OAE_W::new(self)
    }
    #[doc = "Bits 9:10 - GTIOCA Pin Disable Value Setting"]
    #[inline(always)]
    #[must_use]
    pub fn oadf(&mut self) -> OADF_W<GTIOR_SPEC, 9> {
        OADF_W::new(self)
    }
    #[doc = "Bit 13 - Noise Filter A Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nfaen(&mut self) -> NFAEN_W<GTIOR_SPEC, 13> {
        NFAEN_W::new(self)
    }
    #[doc = "Bits 14:15 - Noise Filter A Sampling Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn nfcsa(&mut self) -> NFCSA_W<GTIOR_SPEC, 14> {
        NFCSA_W::new(self)
    }
    #[doc = "Bits 16:20 - GTIOCB Pin Function Select"]
    #[inline(always)]
    #[must_use]
    pub fn gtiob(&mut self) -> GTIOB_W<GTIOR_SPEC, 16> {
        GTIOB_W::new(self)
    }
    #[doc = "Bit 22 - GTIOCB Pin Output Value Setting at the Count Stop"]
    #[inline(always)]
    #[must_use]
    pub fn obdflt(&mut self) -> OBDFLT_W<GTIOR_SPEC, 22> {
        OBDFLT_W::new(self)
    }
    #[doc = "Bit 23 - GTIOCB Pin Output Setting at the Start/Stop Count"]
    #[inline(always)]
    #[must_use]
    pub fn obhld(&mut self) -> OBHLD_W<GTIOR_SPEC, 23> {
        OBHLD_W::new(self)
    }
    #[doc = "Bit 24 - GTIOCB Pin Output Enable"]
    #[inline(always)]
    #[must_use]
    pub fn obe(&mut self) -> OBE_W<GTIOR_SPEC, 24> {
        OBE_W::new(self)
    }
    #[doc = "Bits 25:26 - GTIOCB Pin Disable Value Setting"]
    #[inline(always)]
    #[must_use]
    pub fn obdf(&mut self) -> OBDF_W<GTIOR_SPEC, 25> {
        OBDF_W::new(self)
    }
    #[doc = "Bit 29 - Noise Filter B Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nfben(&mut self) -> NFBEN_W<GTIOR_SPEC, 29> {
        NFBEN_W::new(self)
    }
    #[doc = "Bits 30:31 - Noise Filter B Sampling Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn nfcsb(&mut self) -> NFCSB_W<GTIOR_SPEC, 30> {
        NFCSB_W::new(self)
    }
...
#[doc = "General PWM Timer I/O Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gtior::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gtior::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
