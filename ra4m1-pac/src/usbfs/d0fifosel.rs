...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn curpipe(&mut self) -> CURPIPE_W<D0FIFOSEL_SPEC, 0> {
        CURPIPE_W::new(self)
    }
    #[doc = "Bit 8 - FIFO Port Endian Control"]
    #[inline(always)]
    #[must_use]
    pub fn bigend(&mut self) -> BIGEND_W<D0FIFOSEL_SPEC, 8> {
        BIGEND_W::new(self)
    }
    #[doc = "Bit 10 - FIFO Port Access Bit Width"]
    #[inline(always)]
    #[must_use]
    pub fn mbw(&mut self) -> MBW_W<D0FIFOSEL_SPEC, 10> {
        MBW_W::new(self)
    }
    #[doc = "Bit 12 - DMA/DTC Transfer Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dreqe(&mut self) -> DREQE_W<D0FIFOSEL_SPEC, 12> {
        DREQE_W::new(self)
    }
    #[doc = "Bit 13 - Auto Buffer Memory Clear Mode Accessed after Specified Pipe Data is Read"]
    #[inline(always)]
    #[must_use]
    pub fn dclrm(&mut self) -> DCLRM_W<D0FIFOSEL_SPEC, 13> {
        DCLRM_W::new(self)
    }
    #[doc = "Bit 14 - Buffer Pointer Rewind Note: Only 0 can be read."]
    #[inline(always)]
    #[must_use]
    pub fn rew(&mut self) -> REW_W<D0FIFOSEL_SPEC, 14> {
        REW_W::new(self)
    }
    #[doc = "Bit 15 - Read Count Mode"]
    #[inline(always)]
    #[must_use]
    pub fn rcnt(&mut self) -> RCNT_W<D0FIFOSEL_SPEC, 15> {
        RCNT_W::new(self)
    }
...
#[doc = "D0FIFO Port Select Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`d0fifosel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`d0fifosel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
