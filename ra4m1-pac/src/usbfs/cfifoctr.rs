...
pub type R = crate::R<CFIFOCTR_SPEC>;
#[doc = "Register `CFIFOCTR` writer"]
pub type W = crate::W<CFIFOCTR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bclr(&mut self) -> BCLR_W<CFIFOCTR_SPEC, 14> {
        BCLR_W::new(self)
    }
    #[doc = "Bit 15 - Buffer Memory Valid Flag"]
    #[inline(always)]
    #[must_use]
    pub fn bval(&mut self) -> BVAL_W<CFIFOCTR_SPEC, 15> {
        BVAL_W::new(self)
    }
